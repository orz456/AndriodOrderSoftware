...
public class OrderAdapter2 extends RecyclerView.Adapter<OrderAdapter2.ViewHolder> {
    ...
    public OrderAdapter2(List<Publish> orderList, Context context, String username) {
    ...
    public OrderAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final OrderAdapter2.ViewHolder holder = new OrderAdapter2.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull OrderAdapter2.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        Publish publish = orderList.get(position);
        ...
        // Finished
        holder.tv_btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (status == 4){
                    confirmOrder(position);
                    Toast.makeText(context,"This order is confirmed!",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(context,"This order has already confirmed!",Toast.LENGTH_SHORT).show();
                }
